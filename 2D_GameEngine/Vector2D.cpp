...
Vector2D& operator-(Vector2D& v1, const Vector2D& v2) { return v1.Substract(v2); }
...
Vector2D& Vector2D::operator-= (const Vector2D& vec) { return this->Substract(vec); }
...
Vector2D& Vector2D::Zero() { this->x = this->y = 0; return *this; }
